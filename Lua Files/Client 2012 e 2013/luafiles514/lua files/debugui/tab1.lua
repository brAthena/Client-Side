...
function DebugingInterface_Tab1()
	...
	AddString ( "-- [ Guild ] --" )
	AddMenu ("Empelium Box", buttonEventReceiver_empelium )
	AddMenu ("Guildlevel up!", buttonEventReceiver_guildlup )
	...
	AddMenu ("Move to Castle", buttonEventReceiver_prtg_cas02 )
	...
	AddString ( "-- [ Elemental Change ] --" )
	AddMenu ("Elemental Change Saint" , buttonEventReceiver_elementalSa )
	AddMenu ("Elemental Change Darkness" , buttonEventReceiver_elementalDr )
	AddMenu ("Elemental Change Undead" , buttonEventReceiver_elementalUn )
	AddMenu ("Elemental Change Telekinesis" , buttonEventReceiver_elementalTe )
	AddMenu ("Elemental Change Poison" , buttonEventReceiver_elementalPo )
	AddMenu ("Elemental Change Wind" , buttonEventReceiver_elementalWi )
	AddMenu ("Elemental Change Fire" , buttonEventReceiver_elementalFi )
	AddMenu ("Elemental Change Ground" , buttonEventReceiver_elementalGr )
	AddMenu ("Elemental Change Water" , buttonEventReceiver_elementalWa )
	AddMenu ("Elemental Change Nothing" , buttonEventReceiver_elementalNo )

	AddString ( "-- [ Status Effects ] --" )
	AddMenu ("Stoncurse Please 'O'" , buttonEventReceiver_stoncurse )
	AddMenu ("Freezing Please '0'" , buttonEventReceiver_freezing )
	AddMenu ("Stun Please '0'" , buttonEventReceiver_stun )
	AddMenu ("Sleep Please '0'" , buttonEventReceiver_sleep )
	AddMenu ("Undead Please '0'" , buttonEventReceiver_undead )
	AddMenu ("Poison Please '0'" , buttonEventReceiver_poison )
	AddMenu ("Curse Please '0'" , buttonEventReceiver_curse )
	AddMenu ("Silence Please '0'" , buttonEventReceiver_silence )
	AddMenu ("Confusion Please '0'" , buttonEventReceiver_confusion )
	AddMenu ("Blind Please '0'" , buttonEventReceiver_blind )

	AddString ( "-- [ Testlayer ] --")                            
	AddMenu ("Testlayer" , buttonEventReceiver_testlayer )

	AddString ( "-- [ Stopwatch ] --")                            
	AddMenu ("Stopwatch" , buttonEventReceiver_Stopwatch )
