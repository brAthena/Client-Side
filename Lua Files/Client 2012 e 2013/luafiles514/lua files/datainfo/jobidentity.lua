JTtbl =
{
	...
	-- 999에 도달하면 저위쪽에 만들어놓은 JT_NEW_NPC_START (400) 부터 다시 추가해주세요~
	...
	-----------------------------------------
	-- 추가직업 시작 (2차 하이 클라스 이후에 새로 직업을 추가 하게 되면 이뒤로 하자)
	...
	-- 각종 BABY들 ( 이 이후 추가 되는 직업은 아이 변환 불가로 ;;; )
	JT_NOVICE_B						=	4023,
	JT_SWORDMAN_B					=	4024,
	JT_MAGICIAN_B					=	4025,
	JT_ARCHER_B						=	4026,
